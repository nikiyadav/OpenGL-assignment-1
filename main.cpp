...
float rotation = 0.0f;
GLuint VBO, VAO;
GLuint vao1, vao2,vbo1, vbo2,ibo1, ibo2;
unsigned int l, r;
GLint gWorldLocation, reboundLocation;
...
static void CreateVertexBuffer() {
	...
	glBufferData(GL_ELEMENT_ARRAY_BUFFER, 2898*sizeof(unsigned int), faces, GL_STATIC_DRAW);
...
static void CompileShaders() {
	...
	reboundLocation = glGetUniformLocation(ShaderProgram, "rebound");
}
...
static void onDisplay() {
	...
	Matrix4f rebound;
	rebound.m[0][0] = 1.0f; rebound.m[0][1] = 0.0f; rebound.m[0][2] = 0.0f; rebound.m[0][3] = 0.0f; 
	rebound.m[1][0] = 0.0f; rebound.m[1][1] = abs(cosf(rotation)); rebound.m[1][2] = 0.0f; rebound.m[1][3] = 0.0f; 
	rebound.m[2][0] = 0.0f; rebound.m[2][1] = 0.0f; rebound.m[2][2] = 1.0f; rebound.m[2][3] = 0.0f; 
	rebound.m[3][0] = 0.0f; rebound.m[3][1] = 0.0f; rebound.m[3][2] = 0.0f; rebound.m[3][3] = 1.0f; 

	glUniformMatrix4fv(reboundLocation, 1, GL_TRUE, &rebound.m[0][0]);
